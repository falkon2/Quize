  ...
  <div>
    <div  className="container mx-auto">
      <div className="py-5">
        ...
        <div className="py-3">
          <div data-theme="night" className="max-w-full w-full h-fu bg-neutral overflow-x-auto shadow rounded-lg">
    ...
    <div className="sm:flex flex-wrap justify-center items-center text-center gap-8">
      ...
      <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mt-6  px-4 py-4 bg-white shadow-lg rounded-xl ">
        ...
        <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
          Statistics of the students in a chart leaderboard format to udnerasiodjaisdj iosjad.
        </p>
        <button className="text-md btn-primary p-9 rounded-xl  text-gray-500 dark:text-gray-300 py-4">
          Visit
        </button>
