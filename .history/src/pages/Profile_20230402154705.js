...
export default function Profile() {
  ...
  <div className="chat-image avatar">
    <div className="w-10 rounded-full">
        <Jdenticon value={name} size={36} /></div>
  </div>
  <div className="chat-bubble">Polynomials IX-B. Scored-19  </div>
</div>
<div className="chat chat-start">
  <div className="chat-image avatar">
    <div className="w-10 rounded-full">
  ...
  <div className="chat-bubble">Polynomials IX-B. Scored-14</div>
</div>
<div className="chat chat-start">
  <div className="chat-image avatar">
    <div className="w-10 rounded-full">
  ...
  <div className="chat-bubble">Polynomials IX-B. Scored-13</div>
</div>
                        </div>
                    </div>
                </div>
