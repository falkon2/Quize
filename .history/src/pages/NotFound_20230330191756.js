...
export default function NotFound() {
    return (
        <div>
<div class="lg:px-24 lg:py-24 md:py-20 md:px-44 px-4 py-24 w-full w-screen items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-16">
