    ...
    <body class=" antialiased">
        ...
        <div className="relative flex flex-col flex-1 z-20 overflow-y-auto overflow-x-hidden">
          ...
          <div className=' w-screen h-screen grid grid-rows-2 text-4xl'>
            <div className='w-full h-full text-center items-center justify-center flex bg-blue-500 md:h-screen'>
              hi
            </div>
            <div  className='w-full h-full text-center items-center justify-center flex bg-black md:h-screen'>
              hello
            </div>
          </div>
        </div>
