  ...
  render() {
    return (
      <div>
        ...
        <body class="flex backdrop-blur-md bg-white/50 min-h-screen overflow-hidden">
          <SideBar />
            ...
            <main class="p-6 sm:p-10 space-y-6">
              <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                ...
                <div class="flex flex-wrap items-start justify-end -mb-3">
                  ...
                  <button onClick={()=>{window.location.replace("/create-quiz")}} id="new-Quiz" class="inline-flex px-5 py-3 text-center justify-center items-center text-secondary bg-neutral hover:bg-primary hover:text-neutral focus:bg-primary focus:text-neutral rounded-md ml-6 mb-3">
                    <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="flex-shrink-0 h-6 w-6 text-secondary hover:text-neutral -ml-1 mr-2">
              ...
              <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                <div class="flex items-center p-8 text-white bg-neutral shadow rounded-lg">
                  ...
                  <div>
                    ...
                    <span class="block text-secondary">Students</span>
                  </div>
                </div>
                  ...
                  <div class="overflow-y-auto" style={{ maxHeight: "24rem" }}>
                    <ul class="p-6 space-y-6">
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-secondary">Calvin Steward</span>
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-secondary">Ralph Richards</span>
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-secondary">Bernard Murphy</span>
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-secondary">Arlene Robertson</span>
                        <span class="ml-auto font-semibold">8.2</span>
                      </li>
                      <li class="flex items-center">
                        <div class="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                        ...
                        <span class="text-secondary">Jane Lane</span>
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-secondary">Pat Mckinney</span>
                      ...
                      <li class="flex items-center">
                        ...
                        <span class="text-secondary">Norman Walters</span>
                        <span class="ml-auto font-semibold">2.7</span>
                      </li>
                    </ul>
                  </div>
                </div>
                <div class="flex flex-col row-span-3 bg-neutral focus:bg- text-secondary shadow rounded-lg">
