      ...
      <div className="hero min-h-screen bg-[cbd5e1]">
        <div id="user" className="hero-content flex-col lg:flex-row-reverse">
          <div className="text-center lg:text-left">
            <h1 className="text-5xl py-1 font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">Login now!</h1>
            <p className="py-6 text-[666666]">Experience the world of mathematics in a very fun way in our website, quiz. It is an interactive way for children to learn.</p>
          </div>
