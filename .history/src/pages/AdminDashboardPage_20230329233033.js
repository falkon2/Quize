          ...
          <aside class="hidden sm:flex sm:flex-col">
            ...
            <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
              <nav class="flex flex-col mx-3 my-6 space-y-4">
                <a href="#"  class="tooltip tooltip-open tooltip-right inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg" data-tip="Settings">
                  <span  class="sr-only">Folders</span>
                  <HiAcademicCap  title='Student' size={35} />
                </a>
                <a href="#" class="inline-flex items-center justify-center py-3 text-purple-600 bg-white rounded-lg tooltip tooltip-open tooltip-right" data-tip="Settings">
