            ...
            <main class="p-6 sm:p-10 space-y-6">
              <div class="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                ...
                <div class="flex flex-wrap items-start justify-end -mb-3">
                  ...
                  <button onClick={()=>{window.location.replace("/create-quiz")}} id="new-Quiz" class="inline-flex px-5 py-3 text-center justify-center items-center text-secondary bg-neutral hover:neutral/30 focus:bg-purple-700 rounded-md ml-6 mb-3">
