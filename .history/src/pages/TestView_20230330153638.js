  ...
  <div>
    <div  className="container mx-auto">
      <div className="py-8">
        <div className="flex flex-wrap flex-row mb-1 sm:mb-0 justify-center w-full">
          <h2 className="text-4xl justify-center items-center text-center bg-secondary p-6 px-20 rounded-full  text-white">Tests</h2>
    ...
    <div className="sm:flex flex-wrap justify-center items-center text-center gap-8">
      <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-neutral text-white mt-6  shadow-lg rounded-xl dark:bg-gray-800">
        ...
        <button className="text-md btn-primary p-9 rounded-full  text-gray-500 dark:text-gray-300 py-4">
          Visit
        </button>
      </div>
