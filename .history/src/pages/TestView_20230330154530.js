...
export default class TestView extends React.Component {
  ...
  <div>
    <div  className="container mx-auto">
      <div className="py-5">
        <div className=" self-center items-center  flex-wrap flex-row mb-1 sm:mb-0 justify-center w-full">
        ...
        <div className="py-3">
          <div data-theme="night" className="max-w-full w-full min-w-screen h-full bg-neutral overflow-x-auto shadow rounded-lg">
