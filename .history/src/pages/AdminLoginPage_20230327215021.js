  ...
  */
  ...
  <div id="user" className="hero-content flex-col lg:flex-row-reverse">
    <div className="text-center lg:text-left">
      ...
      <p className="py-6 text-blue-50">Experience the world of mathematics in a very fun way in our website, quizzy.It is very good for children and interactive project.</p>
    </div>
