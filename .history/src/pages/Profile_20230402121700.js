        ...
        <div class="container mx-auto my-60">
            <div>
                ...
                <div class="bg-white relative shadow-lg  rounded-lg w-5/6 md:w-5/6  lg:w-4/6 xl:w-3/6 mx-auto">
                    ...
                    <Jdenticon value={`${name}`} size={64} class="rounded-full mx-auto absolute -top-20 w-32 h-32 shadow-md border-4 border-white transition duration-200 transform hover:scale-110 />
                    </div>
