            ...
            <main class="p-6 sm:p-10 space-y-6">
              ...
              <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
                <div class="flex flex-col md:col-span-2 md:row-span-2 text-white bg-gray-800 shadow rounded-lg">
                  <div class="px-6 py-5 font-semibold border-b border-gray-100">LeaderBoard</div>
                ...
                <div class="flex items-center p-8 text-white bg-gray-800 shadow rounded-lg">
                <a href="/admin-dashboard/test-view"><div class="inline-flex flex-shrink-0 items-center justify-center h-16 w-16 text-yellow-600 bg-yellow-100 rounded-full mr-6">
                  <svg aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="h-6 w-6">
                ...
                <div class="row-span-3 text-white bg-gray-800 shadow rounded-lg">
                  <div class="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                    ...
                    <button type="button" class="inline-flex justify-center rounded-md px-1 -mr-1 text-white bg-gray-800 text-sm leading-5 font-medium  hover:text-gray-600" id="options-menu" aria-haspopup="true" aria-expanded="true">
                      Descending
