...
export default class TestView extends React.Component {
  ...
  <div>
      ...
      <div className="py-8">
        ...
        <div className="py-4">
          <div data-theme="night" className="max-w-full bg-neutral overflow-x-auto shadow rounded-lg">
            <table className="w-full leading-normal">
              <thead>
                <tr>
                  <th
                    scope="col"
                    className="px-5 py-3 bg-neutral  border-b border-gray-200 text-gray-800  text-left text-sm uppercase font-normal"
                  >
                    Test Name
                  </th>
                  <th
              ...
              <tbody>
                <tr>
                  <td className="px-5 py-5 border-b border-gray-200 bg-neutral text-sm">
            ...
            <div className="px-5 bg-neutral py-5 flex flex-col xs:flex-row items-center xs:justify-between">
              <div className="flex items-center">
                <button
                  type="button"
                  className="w-full p-4 border text-base rounded-l-xl text-gray-600 bg-neutral hover:bg-gray-100"
                >
                  <svg
                    width="9"
                    fill="currentColor"
                ...
                <button
                  type="button"
                  className="w-full px-4 py-2 border text-base text-gray-600 bg-neutral hover:bg-gray-100"
                >
                  2
                </button>
                <button
                  type="button"
                  className="w-full px-4 py-2 border-t border-b text-base text-gray-600 bg-neutral hover:bg-gray-100"
                >
                  3
                </button>
                <button
                ...
                <button
                  type="button"
                  className="w-full p-4 border-t border-b border-r text-base  rounded-r-xl text-gray-600 bg-neutral hover:bg-gray-100"
                >
                  <svg
                    width="9"
                    fill="currentColor"
    ...
    <div className="sm:flex flex-wrap justify-center items-center text-center gap-8">
      <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 px-4 py-4 bg-neutral mt-6  shadow-lg rounded-lg dark:bg-gray-800">
        <div className="flex-shrink-0">
