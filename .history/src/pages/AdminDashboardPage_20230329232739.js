        ...
        <body class="flex bg-gray-100 min-h-screen">
          <aside class="hidden sm:flex sm:flex-col">
            ...
            <div class="flex-grow flex flex-col justify-between text-gray-500 bg-gray-800">
              ...
              <div class="inline-flex items-center justify-center h-20 w-20 border-t border-gray-700  tooltip tooltip-open tooltip-right" data-tip="hello">
                <button class="p-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg">
                  <span class="sr-only">Settings</span>
                  <IoSettings size={35} className='tooltip tooltip-open tooltip-right' data-tip="Settings" />
                </button>
              </div>
            </div>
          </aside>
