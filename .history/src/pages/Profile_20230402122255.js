                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-5 w-full flex flex-col items-center overflow-hidden text-sm">
                                <a href="#" class="w-full border-t border-gray-100 text-gray-600 py-4 pl-6 pr-3  block hover:bg-gray-100 transition duration-150">
                                    <img src="https://avatars0.githubusercontent.com/u/35900628?v=4" alt="" class="rounded-full pl-1 h-6 shadow-md inline-block mr-2"/>
                                        Polynomials IX-B
                                        <span class="text-gray-500 text-xs">Scored-19</span>
                                </a>
