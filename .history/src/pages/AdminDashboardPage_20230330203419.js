          ...
          <div class="flex-grow text-gray-800">
            ...
            <main class="p-6 sm:p-10 space-y-6">
              ...
              <section class="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
                ...
                <div class="flex items-center p-8 text-white bg-neutral focus:bg-primary shadow rounded-lg">
              ...
              <section class="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
                <div class="flex flex-col md:col-span-2 md:row-span-2 text-white bg-neutral focus:bg-primary shadow rounded-lg">
                ...
                <div class="row-span-3 text-white bg-neutral focus:bg-primary shadow rounded-lg">
                  <div class="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                    <span>Students by average mark</span>
                    <button type="button" class="inline-flex justify-center rounded-md px-1 -mr-1 text-white bg-neutral focus:bg-primary text-sm leading-5 font-medium  hover:text-gray-600" id="options-menu" aria-haspopup="true" aria-expanded="true">
                      Descending
                ...
                <div class="flex flex-col row-span-3 bg-neutral focus:bg-primary text-white shadow rounded-lg">
