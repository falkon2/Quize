          ...
          <div data-theme="night" className="max-w-full bg-neutral overflow-x-auto shadow rounded-lg">
            <table className="w-full leading-normal">
              <thead>
                <tr>
                  <th
                    scope="col"
                    className="px-5 py-3 bg-neutral text-white  border-b border-gray-200 text-gray-800  text-left text-sm uppercase font-normal"
                  >
                    Test Name
                  </th>
                  <th
            ...
            <div className="px-5 bg-neutral text-white py-5 flex flex-col xs:flex-row items-center xs:justify-between">
              <div className="flex items-center">
                <button
                  type="button"
                  className="w-full p-4 border text-base rounded-l-xl text-gray-600 bg-neutral text-white hover:bg-gray-100"
                >
                  <svg
                    width="9"
                    fill="currentColor"
                ...
                <button
                  type="button"
                  className="w-full px-4 py-2 border text-base text-gray-600 bg-neutral text-white hover:bg-gray-100"
                >
                  2
                </button>
                <button
                  type="button"
                  className="w-full px-4 py-2 border-t border-b text-base text-gray-600 bg-neutral text-white hover:bg-gray-100"
                >
                  3
                </button>
                <button
                ...
                <button
                  type="button"
                  className="w-full p-4 border-t border-b border-r text-base  rounded-r-xl text-gray-600 bg-neutral text-white hover:bg-gray-100"
                >
                  <svg
                    width="9"
                    fill="currentColor"
