    ...
    <body class=" antialiased">
        ...
        <div className="relative flex flex-col flex-1 z-20 overflow-y-auto overflow-x-hidden">
          ...
          <div className=' w-screen h-screen flex flex-rows-2 text-4xl'>
            <div className='w-full h-full text-center items-center justify-center   bg-blue-500 '>
              hi
            </div>
            <div  className='w-full h-full text-center items-center justify-center   bg-black '>
              hello
            </div>
          </div>
          </div>
