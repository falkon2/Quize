...
export default function Profile() {
    ...
    <body class="bg-gray-300 antialiased">
        ...
        <div className='w-1/2 h-full text-center items-center justify-center flex bg-blue-500'>
          hi
        </div>
        <div  className='w-1/2 h-full text-center items-center justify-center flex bg-black'>
          hello
        </div>
      </div>
        </div>
