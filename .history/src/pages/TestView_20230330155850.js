...
export default class TestView extends React.Component {
  ...
  <div>
    ...
    <div className="sm:flex flex-wrap justify-center items-center text-center gap-8">
      ...
      <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/4 mt-6  px-4 py-4 bg-white shadow-lg rounded-xl ">
        <div className="flex-shrink-0">
          <div className="flex items-center mx-auto justify-center h-12 w-12 rounded-md bg-gray-600 text-white">
            <svg
              width="20"
        ...
        <h3 className="text-2xl sm:text-xl text-white bg-primary font-semibold py-4">
          LeaderBoard
        </h3>
        <p className="text-md  text-gray-500 dark:text-gray-300 py-4">
