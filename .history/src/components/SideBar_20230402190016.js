...
function Sidebar({ sidebarOpen, setSidebarOpen, link }) {
            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup activecondition={pathname === {link}} >
                {(handleClick, open) => {
                    ...
                    <React.Fragment>
                      <a
                        ...
                        className={`block text-slate-200 truncate transition duration-150 ${
                          pathname === {link} || pathname.includes(link) ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                  ...
                  to={link}
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes({link}) ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
