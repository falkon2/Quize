            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup activecondition={pathname.includes('TestsView')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 truncate transition duration-150 ${
                          pathname.includes('TestsView') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                  ...
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('/admin-dashboard/test-view') ? 'hover:text-black-200' : 'hover:text-black'
                  }`}
                >
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              ...
                              <path
                                className={`fill-current ${pathname.includes('TestsView') ? 'text-indigo-300' : 'text-slate-400'}`}
                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('TestsView') ? 'text-indigo-600' : 'text-slate-700'}`}
