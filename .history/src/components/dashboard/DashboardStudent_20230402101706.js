          ...
          <table className="table-auto w-full">
            ...
            <tbody className="text-sm font-medium divide-y divide-slate-100">
              ...
              <tr>
                ...
                <td className="p-2">
                  <div className="text-center cursor-pointer text-sky-500">View</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
              ...
              <tr>
                ...
                <Link to="/student-result"><td className="p-2">
                  <div className="text-center items-center justify-center cursor-pointer text-sky-500">View</div>
                </td></Link>
              </tr>
                            {/* Row */}
                            {/* Row */}
