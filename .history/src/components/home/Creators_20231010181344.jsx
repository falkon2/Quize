          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                ...
                <p className="text-xl text-gray-600">With a wealth of experience as the Head of the Mathematics Department and a PhD in
            Mathematics, Munindra Sir provided invaluable guidance, shaping the project's vision
            and direction.</p>
              </div>
              {/* Tabs buttons */}
