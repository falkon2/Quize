...
export default function FeaturesBlocks() {
  return (
    <section className="relative bg-slate-300">
      ...
      <div className="absolute inset-0 top-1/2 md:mt-24 lg:mt-0 bg-slate-300 pointer-events-none" aria-hidden="true"></div>
        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Cutting-Edge Technology 🚀</h4>
              <p className="text-gray-600 text-center">Quize Uses the Best in the Industry.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Insightful Analytics 🔍</h4>
              <p className="text-gray-600 text-center">Understand Performance with Quize's Dashboard</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Blazingly Fast Performance ⚡</h4>
              <p className="text-gray-600 text-center">Experience Zero Lag on Quize</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Profile Management 🖥️</h4>
              <p className="text-gray-600 text-center">Keep Track of Progress on Quize</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Innovative Features 🔥</h4>
              <p className="text-gray-600 text-center">Quize Offers More Than Just Assessments</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Effective Performance Tracking 🤖</h4>
