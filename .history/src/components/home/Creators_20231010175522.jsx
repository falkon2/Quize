...
import FeaturesBg from './images/hero-images.png';
import FeaturesElement from './images/chart.png'
...
export default function Creator() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 bg-slate-300 pointer-events-none mb-16" aria-hidden="true"></div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Munindra Sir </div>
              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto transform animate-float rounded" src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80" width="500" height="462" alt="Features bg" />
                  </div>
                </Transition>
                {/* Item 2 */}
                <Transition
                  ...
                  leaveEnd="opacity-0 -translate-y-16"
                >
                  <div className="relative object-center object-scale-down inline-flex flex-col">
                    <img className="md:max-w-none mx-auto transform animate-float rounded" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80" width="500" height="462" alt="Features bg" />
                  </div>
                </Transition>
                {/* Item 3 */}
                <Transition
                ...
                >
                  <div className="relative inline-flex flex-col">
                    <img className="md:max-w-none mx-auto transform animate-float rounded" src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80" width="500" height="462" alt="Features bg" />
                  </div>
                </Transition>
              </div>
            </div >
