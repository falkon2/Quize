    ...
    return(
            ...
            <div class="flex-grow flex flex-col justify-between text-gray-500 bg-neutral  ">
              <nav class="flex flex-col mx-3 my-6 space-y-4">
                <NavLink to="/user-dashboard"  class="tooltip tooltip-primary tooltip-right inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg" data-tip="Students">
                ...
                <NavLink to="/admin-dashboard/test-view" class="tooltip tooltip-primary tooltip-right inline-flex items-center justify-center py-3 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg" data-tip="Tests">
