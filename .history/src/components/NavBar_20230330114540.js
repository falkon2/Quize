    ...
    return (
      ...
      <div className="navbar bg-gray-800 sticky top-0 z-50" >
        ...
        <div className="flex-1">
          <Link to={this.link}><img src="https://cdn.discordapp.com/attachments/916242371652509726/1090584639376212048/eyRg7yY.png" className="btn btn-ghost normal-case" alt='Quize logo' /></Link>
        </div>
