  ...
  return(
    ...
    <div class="flex-grow flex flex-col justify-between text-gray-500   ">
      <nav class="flex flex-col mx-3 my-6 space-y-4">
        ...
        <div class="tooltip tooltip-primary tooltip-right flex py-3 items-center justify-center hover:text-white hover:bg-primary h-20 w-20 border-t border-gray-700 " data-tip="Settings">
