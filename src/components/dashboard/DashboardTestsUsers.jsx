            ...
            <tbody className="text-sm font-medium divide-y divide-slate-100">
              ...
              <tr>
                ...
                <td onClick={()=>{window.location.replace("/student-result")}} className="p-2">
                  <div className="text-center cursor-pointer rounded-full hover:bg-sky-200 text-sky-500">N/A</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
              ...
              <tr>
                ...
                <td onClick={()=>{window.location.replace("/student-result")}} className="p-2">
                  <div className="text-center cursor-pointer rounded-full hover:bg-sky-200 text-sky-500">23</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
